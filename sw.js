...
const VERSION = 'hb-v2-p2c';
const SHELL = ['./', './index.html', './manifest.webmanifest', './shared/dates.js', './shared/recurrence.js', './shared/planner.js', './shared/attachments.js', './icons/icon-192.png', './icons/icon.svg'];
